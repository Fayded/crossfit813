...
$of_options[] = array( "name" => "",
					"desc" => "",
					"id" => "home_heading",
					"std" => "Home Screen layout options",
					"icon" => false,
					"type" => "info");

$of_options[] = array( "name" 		=> "Home Type",
					"desc" 		=> "Select your home type.",
					"id" 		=> "rnr_home_look_type",
					"type" 		=> "select",
					"options" 	=> array("Regular","Full Screen", "Regular with padding"));	
...
$of_options[] = array( "name" 		=> "Home Section Type",
					...
					"id" 		=> "rnr_home_type",
					"type" 		=> "select",
					"options" 	=> array("Revolution Slider","FullScreen Slider","Video","Boxed Content", "Full Width Content"));	

$of_options[] = array( "name" => "",
					"desc" => "",
					"id" => "home_video_heading",
					"std" => "Home Video Youtube URL Link",
					"icon" => false,
					"type" => "info");	
...
$of_options[] = array( "name" => "",
					...
					"id" => "rnr_home_video_link",
					"std" => "",
					"type" => "text");	
					
$of_options[] = array( "name" => "Enable Mute Video",
					"desc" => "",
					"id" => "rnr_enable_mute_video",
					"std" => "",
					"type" => "checkbox");	
