...
<?php if($smof_data['rnr_social_email'] != "") { ?>
    <div class="social-icon social-email"><a href="<?php echo $smof_data['rnr_social_email']; ?>" target="_blank" title="<?php _e( 'Email', 'rocknrolla' ) ?>"><?php _e( 'Email', 'rocknrolla' ) ?></a></div>
<?php } ?>
